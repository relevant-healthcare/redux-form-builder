...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _field_set_wrapper = __webpack_require__(49);

	var _field_set_wrapper2 = _interopRequireDefault(_field_set_wrapper);
	...
	var Form = function (_React$Component) {
	  ...
	  function Form() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Form.__proto__ || Object.getPrototypeOf(Form)).call.apply(_ref, [this].concat(args))), _this), _this.onSubmit = function (event) {
	      if (_this.props.onSubmit) {
	        _this.props.onSubmit(_lodash2.default.assign({}, event, { target: { value: _this.props.object } }));
	      }
	  ...
	  _createClass(Form, [{
	    ...
	    value: function render() {
	      var htmlFormProps = _lodash2.default.pick(this.props, 'className', 'onChange');

	      return _react2.default.createElement(
	        'form',
	        _extends({ action: this.action, method: 'post' }, htmlFormProps, { onSubmit: this.onSubmit }),
	        _react2.default.createElement('input', { name: 'utf8', type: 'hidden', value: '\u2713' }),
	        this.isPersisted ? _react2.default.createElement('input', { type: 'hidden', name: '_method', value: 'patch' }) : null,
	        _react2.default.createElement('input', { type: 'hidden', name: 'authenticity_token', value: this.props.authenticityToken }),
	        this.props.children
	      );
	    }
	  }, {
	...
	var StatefulForm = (0, _form_scoped_state_wrapper2.default)(function (object) {
	  return { object: object };
	})(Form);

	var FormFieldSet = (0, _field_set_wrapper2.default)(function (props) {
	  return { localName: null, remoteName: props['as'], formKey: props['formKey'] || props['as'] };
	})(StatefulForm);

	var FormInitializer = function (_React$Component2) {
	  _inherits(FormInitializer, _React$Component2);

	  function FormInitializer(props) {
	    _classCallCheck(this, FormInitializer);

	    var _this2 = _possibleConstructorReturn(this, (FormInitializer.__proto__ || Object.getPrototypeOf(FormInitializer)).call(this, props));

	    props.setFormObject(props.formKey || props.as, props['for']);
	    return _this2;
	  }

	  _createClass(FormInitializer, [{
	    ...
	    value: function componentWillReceiveProps(props) {
	      ...
	      if (!_lodash2.default.isEqual(this.props['for'], props['for']) || !_lodash2.default.isEqual(this.props.formKey, props.formKey) || !_lodash2.default.isEqual(this.props.as, props.as)) {
	    ...
	    key: 'render',
	    value: function render() {
	      var childProps = _lodash2.default.omit(this.props, 'setFormObject');
	      return _react2.default.createElement(FormFieldSet, childProps);
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(function () {
	  return {};
	}, { setFormObject: _index.setFormObject })(FormInitializer);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mapStateToProps = __webpack_require__(45);

	var _mapStateToProps2 = _interopRequireDefault(_mapStateToProps);

	var _mergeProps = __webpack_require__(46);

	var _mergeProps2 = _interopRequireDefault(_mergeProps);

	var _selectorFactory = __webpack_require__(47);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _wrapMapToProps = __webpack_require__(43);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _verifyPlainObject = __webpack_require__(44);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _verifySubselectors = __webpack_require__(48);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function (mapPropsToFieldNames) {
	  return function (component) {
	    return function (childProps) {
	      return _react2.default.createElement(FieldSetWrapperWithFormContext, _extends({
	        component: component,
	...
	var FieldSetWrapper = function (_React$Component) {
	  _inherits(FieldSetWrapper, _React$Component);

	  function FieldSetWrapper() {
	    _classCallCheck(this, FieldSetWrapper);

	    return _possibleConstructorReturn(this, (FieldSetWrapper.__proto__ || Object.getPrototypeOf(FieldSetWrapper)).apply(this, arguments));
	  }

	  _createClass(FieldSetWrapper, [{
	    key: 'isNamePresent',
	    value: function isNamePresent(name) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(Component, this.props.childProps);
	    }
	  }, {
	    key: 'localName',
	    get: function get() {
	...
	var FieldSetWrapperWithFormContext = (0, _form_context_wrapper2.default)(function (_ref) {
	  var baseLocalPath = _ref.baseLocalPath,
	      baseRemotePath = _ref.baseRemotePath,
	      formKey = _ref.formKey;
	  return { baseLocalPath: baseLocalPath, baseRemotePath: baseRemotePath, inheritedFormKey: formKey };
	})(FieldSetWrapper);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function (mapStateToProps) {
	  return function (component) {
	    return function (childProps) {
	      return _react2.default.createElement(FormContextWrapper, {
	...
	var FormContextWrapper = function (_React$Component) {
	  _inherits(FormContextWrapper, _React$Component);

	  function FormContextWrapper() {
	    _classCallCheck(this, FormContextWrapper);

	    return _possibleConstructorReturn(this, (FormContextWrapper.__proto__ || Object.getPrototypeOf(FormContextWrapper)).apply(this, arguments));
	  }

	  _createClass(FormContextWrapper, [{
	    key: 'render',
	    value: function render() {
	      var Component = this.props.component;
	      return _react2.default.createElement(Component, _extends({}, this.props.mapStateToProps(this.formContextState), this.props.childProps));
	    }
	  }, {
	    key: 'baseLocalPath',
	    get: function get() {
	    ...
	    get: function get() {
	      return _lodash2.default.pick(this, 'baseLocalPath', 'baseRemotePath', 'formKey');
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function (mapScopedStateToProps) {
	  return function (component) {
	    var ConnectedComponent = (0, _reactRedux.connect)(function (_ref, props) {
	      var forms = _ref.forms;
	      var baseLocalPath = props.baseLocalPath,
	          formKey = props.formKey;

	      var formObject = forms[formKey];
	      if (!formObject) {
	        return {};
	      }
	      var scopedFormObject = _lodash2.default.isEmpty(baseLocalPath) ? formObject : _lodash2.default.get(formObject, baseLocalPath);
	      return mapScopedStateToProps(scopedFormObject, props);
	    }, function (dispatch, _ref2) {
	      var baseLocalPath = _ref2.baseLocalPath,
	          formKey = _ref2.formKey;

	      return {
	        onChange: function onChange(value) {
	          dispatch((0, _index.updateFormObject)(formKey, baseLocalPath, value));
	        }
	      };
	    })(component);

	    return (0, _form_context_wrapper2.default)(function (_ref3) {
	      var baseLocalPath = _ref3.baseLocalPath,
	          formKey = _ref3.formKey;
	      return { baseLocalPath: baseLocalPath, formKey: formKey };
	    })(ConnectedComponent);
	  };
	};
...
/***/ (function(module, exports) {
	...
	exports.setFormObject = setFormObject;
	exports.updateFormObject = updateFormObject;
	var SET_FORM_OBJECT = exports.SET_FORM_OBJECT = 'SET_FORM_OBJECT';
	function setFormObject(formKey, object) {
	  return {
	...
	var UPDATE_FORM_OBJECT = exports.UPDATE_FORM_OBJECT = 'UPDATE_FORM_OBJECT';
	function updateFormObject(formKey, path, value) {
	  return {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function formReducer() {
	  ...
	  var handlers = (_handlers = {}, _defineProperty(_handlers, _index.SET_FORM_OBJECT, function () {
	    var formKey = action.formKey,
	        object = action.object;

	    return (0, _immutabilityHelper2.default)(state, _defineProperty({}, formKey, { $set: object }));
	  }), _defineProperty(_handlers, _index.UPDATE_FORM_OBJECT, function () {
	    var formKey = action.formKey,
	        path = action.path,
	        value = action.value;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.UnlabeledControl = exports.LabeledControl = exports.HiddenControl = undefined;
	...
	var _underscore = __webpack_require__(58);
	...
	function HiddenControl(props) {
	  ...
	  return _react2.default.createElement(_input.HiddenInput, { id: id, name: name, value: value });
	}
	...
	function UnlabeledControl(props) {
	  ...
	  return _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(Input, props.inputProps),
	    _.isEmpty(props.errors) ? null : _react2.default.createElement(
	      'span',
	      { className: 'help-inline error-inline' },
	      _underscore2.default.join.apply(_underscore2.default, [', '].concat(_toConsumableArray(_.map(props.errors, 'message'))))
	    )
	  );
	}
	...
	function LabeledControl(props) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'label',
	        { className: 'control-label col-sm-2', htmlFor: props.id },
	        props.label
	      )
	    ),
	    _react2.default.createElement(
	...
	exports.UnlabeledControl = UnlabeledControl;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.TextInput = exports.TextAreaInput = exports.SelectInput = exports.RadioButtonGroupInput = exports.HiddenInput = exports.DateInput = exports.CheckboxInput = undefined;
	    ...
	    _createClass(_class2, [{
	      ...
	      value: function render() {
	        var _props = this.props,
	            ...
	            otherProps = _objectWithoutProperties(_props, ['className', 'value', 'onChange']);

	        className = className || 'input form-control';
	        return _react2.default.createElement('input', _extends({ type: type, className: className, onChange: this.onChange, defaultValue: value }, otherProps));
	      }
	    }]);
	...
	var TextInput = SimpleInput('text');
	var DateInput = SimpleInput('date');
	var HiddenInput = SimpleInput('hidden');

	var CheckboxInput = function (_React$Component2) {
	...
	function SelectInput(_ref4) {
	  ...
	  var className = props.className,
	      value = props.value,
	      otherProps = _objectWithoutProperties(props, ['className', 'value']);
	...
	var RadioButtonGroupInput = function (_React$Component3) {
	  ...
	  function RadioButtonGroupInput() {
	    ...
	    return _possibleConstructorReturn(this, (RadioButtonGroupInput.__proto__ || Object.getPrototypeOf(RadioButtonGroupInput)).apply(this, arguments));
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	...
	s.isBlank          = __webpack_require__(59);
	s.stripTags        = __webpack_require__(61);
	s.capitalize       = __webpack_require__(62);
	s.decapitalize     = __webpack_require__(63);
	s.chop             = __webpack_require__(64);
	s.trim             = __webpack_require__(65);
	s.clean            = __webpack_require__(68);
	s.cleanDiacritics  = __webpack_require__(69);
	s.count            = __webpack_require__(70);
	s.chars            = __webpack_require__(71);
	s.swapCase         = __webpack_require__(72);
	s.escapeHTML       = __webpack_require__(73);
	s.unescapeHTML     = __webpack_require__(75);
	s.splice           = __webpack_require__(77);
	s.insert           = __webpack_require__(78);
	s.replaceAll       = __webpack_require__(79);
	s.include          = __webpack_require__(80);
	s.join             = __webpack_require__(81);
	s.lines            = __webpack_require__(82);
	s.dedent           = __webpack_require__(83);
	s.reverse          = __webpack_require__(84);
	s.startsWith       = __webpack_require__(85);
	s.endsWith         = __webpack_require__(87);
	s.pred             = __webpack_require__(88);
	s.succ             = __webpack_require__(90);
	s.titleize         = __webpack_require__(91);
	s.camelize         = __webpack_require__(92);
	s.underscored      = __webpack_require__(93);
	s.dasherize        = __webpack_require__(94);
	s.classify         = __webpack_require__(95);
	s.humanize         = __webpack_require__(96);
	s.ltrim            = __webpack_require__(97);
	s.rtrim            = __webpack_require__(98);
	s.truncate         = __webpack_require__(99);
	s.prune            = __webpack_require__(100);
	s.words            = __webpack_require__(101);
	s.pad              = __webpack_require__(102);
	s.lpad             = __webpack_require__(104);
	s.rpad             = __webpack_require__(105);
	s.lrpad            = __webpack_require__(106);
	s.sprintf          = __webpack_require__(107);
	s.vsprintf         = __webpack_require__(111);
	s.toNumber         = __webpack_require__(112);
	s.numberFormat     = __webpack_require__(113);
	s.strRight         = __webpack_require__(114);
	s.strRightBack     = __webpack_require__(115);
	s.strLeft          = __webpack_require__(116);
	s.strLeftBack      = __webpack_require__(117);
	s.toSentence       = __webpack_require__(118);
	s.toSentenceSerial = __webpack_require__(119);
	s.slugify          = __webpack_require__(120);
	s.surround         = __webpack_require__(121);
	s.quote            = __webpack_require__(122);
	s.unquote          = __webpack_require__(123);
	s.repeat           = __webpack_require__(124);
	s.naturalCmp       = __webpack_require__(125);
	s.levenshtein      = __webpack_require__(126);
	s.toBoolean        = __webpack_require__(127);
	s.exports          = __webpack_require__(128);
	s.escapeRegExp     = __webpack_require__(67);
	s.wrap             = __webpack_require__(129);
	s.map              = __webpack_require__(130);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var makeString = __webpack_require__(60);
	var defaultToWhiteSpace = __webpack_require__(66);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var escapeRegExp = __webpack_require__(67);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var makeString = __webpack_require__(60);
	var htmlEntities = __webpack_require__(76);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var chars = __webpack_require__(71);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var makeString = __webpack_require__(60);
	var toPositive = __webpack_require__(86);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var adjacent = __webpack_require__(89);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var trim = __webpack_require__(65);
	var decap = __webpack_require__(63);
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	var makeString = __webpack_require__(60);
	var rtrim = __webpack_require__(98);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var isBlank = __webpack_require__(59);
	var trim = __webpack_require__(65);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var makeString = __webpack_require__(60);
	var strRepeat = __webpack_require__(103);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var pad = __webpack_require__(102);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = deprecate(__webpack_require__(109).sprintf,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!function() {
	    ...
	    if (typeof window !== 'undefined') {
	        ...
	        if ("function" === 'function' && __webpack_require__(110)['amd']) {
	            !(__WEBPACK_AMD_DEFINE_RESULT__ = function() {
	                return {
	                    'sprintf': sprintf,
	                    'vsprintf': vsprintf
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = deprecate(__webpack_require__(109).vsprintf,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var toSentence = __webpack_require__(118);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var trim = __webpack_require__(65);
	var dasherize = __webpack_require__(94);
	var cleanDiacritics = __webpack_require__(69);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var surround = __webpack_require__(121);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Field = function (_React$Component) {
	  ...
	  _createClass(Field, [{
	    ...
	    key: 'label',
	    get: function get() {
	      return this.props.label || _underscore2.default.humanize(this.localName);
	    }
	  }, {
	    key: 'inputName',
	    get: function get() {
	      ...
	      return '' + first + _underscore2.default.join.apply(_underscore2.default, [''].concat(_toConsumableArray(indexedRest)));
	    }
	  }, {
	    key: 'inputValue',
	    get: function get() {
	    ...
	    key: 'control',
	    get: function get() {
	      return this.props.control || _control.LabeledControl;
	    }
	  }, {
	    key: 'errors',
	    get: function get() {
	...
	exports.default = (0, _form_scoped_state_wrapper2.default)(function (object, props) {
	  var _ref2;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = (0, _field_set_wrapper2.default)(function (props) {
